...
Today I will talk (quickly!) about using data from my garden in my introductory data science course. 
...
* Why use data from the garden?  
  ...
  - I could use it to teach a lot of intro data science topics. See examples on the course website: https://ds112-lendway.netlify.app/
...
First, I could use the data to introduce almost every topic I intended to teach, including data visualization; data wrangling; adding animation and interactivity to graphs; importing data; and creating nice tables. I'll talk in more detail about this in the extended talk.
